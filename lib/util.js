...
class Util {
  ...
  static deviceConfig = [
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_1", "rssi", "button.enable_ble_script", "button.disable_ble_script", "actionEvents", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {
        "measure_temperature": {"title": {"en": "Device Temperature", "nl": "Apparaat temperatuur"}},
        "measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},
    ...
    },
    {
      ...
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_1", "rssi", "button.enable_ble_script", "button.disable_ble_script", "actionEvents", "deviceGen2"],
      'capabilities_2': ["onoff", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_1", "actionEvents"],
      'capability_options': {
        "measure_temperature": {"title": {"en": "Device Temperature", "nl": "Apparaat temperatuur"}},
        "measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},
        "measure_temperature.2": {"title": {"en": "Temperature Sensor 2", "nl": "Temperatuursensor 2"}},
    ...
    },
    {
      ...
      'capabilities_2': ["onoff", "measure_voltage", "input_1", "actionEvents"],
      'capability_options': {
        "measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},
        "measure_temperature.2": {"title": {"en": "Temperature Sensor 2", "nl": "Temperatuursensor 2"}},
        "measure_temperature.3": {"title": {"en": "Temperature Sensor 3", "nl": "Temperatuursensor 3"}},
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "input_1", "input_3", "rssi", "actionEvents", "deviceGen2"],
      'capabilities_2': ["onoff", "input_1", "actionEvents"],
      'capability_options': {
        "measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},
        "measure_temperature.2": {"title": {"en": "Temperature Sensor 2", "nl": "Temperatuursensor 2"}},
    ...
    {
      'hostname': ['shellyprodm1pm-', 'ShellyProDM1PM-'],
 ...
 // SUPPORTED DEVICES
 let supported_device = ['SBBT-002C', 'SBDW-002C', 'SBMO-003Z', 'SBHT-003C'];
 ...
 BTH[0x03] = { n: 'measure_humidity', t: uint16, f: 0.01, u: "%" };
 BTH[0x02] = { n: 'measure_temperature', t: int16, f: 0.01, u: "tC" };
 ...
 if (BLEConfig.enable === false) {
    ...
    try {
      ...
      for (const driver of drivers) {
        ...
        for (const device of devices) {
          ...
          } else if (purpose === 'flowcard_actions') { /* devices with callbacks for action event trigger card //TODO: eventually remove this and the purpose parameter of this function */
  ...
  async enableBLEProxy(script_id = null, address, password) {
    try {
      ...
      await this.sendRPCCommand('/rpc/rpc/Script.SetConfig?id='+ scriptCreated.result.id +'&config={"enable":true}', address, password);
  ...
  getDeviceConfig(hostname, type = null) {
    try {
      if (type === null) {
        ...
        return Util.deviceConfig.find(r => r.name.includes(hostname));
      } else {
