...
class Util {
  ...
  static deviceConfig = [
    ...
    },
    {
      ...
      "name": "Shelly (Dali) Dimmer (0/1-10V PM)",
      "gen": "gen3",
    ...
    },
    {
      ...
      "battery": true,
      "class": "thermostat",
      "capabilities_1": ["target_temperature", "measure_temperature.thermostat", "measure_temperature", "measure_battery", "valve_position", "rssi"],
      "capabilities_2": [],
      "capability_options": {
