...
class Util {
  ...
  static deviceConfig = [
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_power", "meter_power", "meter_power.total_returned", "meter_power_factor", "measure_voltage", "measure_current", "input_1", "measure_temperature", "rssi", "button.enable_ble_script", "button.disable_ble_script", "deviceGen2"],
      'capabilities_2': ["onoff", "measure_power", "meter_power", "meter_power.total_returned", "meter_power_factor", "measure_voltage", "measure_current", "input_1", "measure_temperature"],
      'capability_options': {
        "measure_temperature": {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}},
