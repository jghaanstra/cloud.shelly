  ...
  constructor(opts) {
    ...
    this.deviceConfig = [
      ...
      },
      {
        ...
        'capability_options': {"meter_power.total": {"title": {"en": "Total Energy", "nl": "Energie totaal"}}},
      ...
      {
        'hostname': ['shelly25-', 'shellyswitch25-'],
        'name': 'Shelly 2.5',
        'gen': 'gen1',
        'type': ['SHSW-25'],
        'channels': 2,
      ...
      {
        'hostname': ['shelly25-roller-', 'shellyswitch25-roller-'],
