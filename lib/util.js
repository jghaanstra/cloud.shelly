...
class Util {
  ...
  static deviceConfig = [
    ...
    },
    {
      ...
      'energy': {},
      'triggers_1': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerInput2On', 'triggerInput2Off', 'triggerInput2Changed', 'triggerInput3On', 'triggerInput3Off', 'triggerInput3Changed', 'triggerInput4On', 'triggerInput4Off', 'triggerInput4Changed', 'triggerTemperature1', 'triggerTemperature2', 'triggerTemperature3', 'triggerHumidity1', 'triggerHumidity2', 'triggerHumidity3', 'triggerPlusInputExternal1On', 'triggerPlusInputExternal1Off', 'triggerPlusInputExternal1Changed', 'triggerPlusInputExternal2On', 'triggerPlusInputExternal2Off', 'triggerPlusInputExternal2Changed', 'triggerPlusInputExternal3On', 'triggerPlusInputExternal3Off', 'triggerPlusInputExternal3Changed'],
      'triggers_2': [],
    ...
    },
    {
      ...
      'class': 'windowcoverings',
      'capabilities_1': ["windowcoverings_state", "windowcoverings_set", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_1", "input_2", "rssi", "button.enable_ble_script", "button.disable_ble_script", "deviceGen2"],
      'capabilities_2': ["windowcoverings_state", "windowcoverings_set", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_3", "input_4"],
      'capability_options': {'measure_temperature': {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}},"button.enable_ble_script": {"maintenanceAction": true, "title": {"en": "Start BLE Proxy", "nl": "Start BLE Proxy"}},"button.disable_ble_script": {"maintenanceAction": true, "title": {"en": "Stop BLE Proxy", "nl": "Stop BLE Proxy"}}},
      'energy': {},
      'triggers_1': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerInput2On', 'triggerInput2Off', 'triggerInput2Changed'],
