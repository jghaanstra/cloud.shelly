...
class Util {
  ...
  static deviceConfig = [
    ...
    },
    {
      ...
      'triggers': ['triggerMeterPowerFactor', 'triggerMeterPowerReturned', 'triggerMeasurePowerTotal'],
      'callbacks': [],
    ...
    },
    {
      ...
      'energy': {"cumulative": true},
      'triggers': ['triggerMeterPowerFactor', 'triggerMeasurePowerTotal', 'triggerMeterPowerTotal', 'triggerMeterPowerReturned', 'triggerMeterPowerReturnedTotal'],
      'callbacks': [],
    ...
    },
    {
      ...
      'battery': true,
      'class': 'button',
      'capabilities_1': ["measure_battery", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {},
      'energy': {"batteries": ["INTERNAL"]},
      'triggers': [],
