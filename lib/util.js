...
class Util {
  ...
  static deviceConfig = [
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_temperature", "input_1", "rssi", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {"measure_temperature": {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}},"measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},"measure_temperature.2": {"title": {"en": "Temperature Sensor 2","nl": "Temperatuursensor 2"}},"measure_temperature.3": {"title": {"en": "Temperature Sensor 3", "nl": "Temperatuursensor 3"}},"measure_humidity.1": {"title": {"en": "Humidity Sensor 1", "nl": "Vochtsensor 1"}},"measure_humidity.2": {"title": {"en": "Humidity Sensor 2","nl": "Vochtsensor 2"}},"measure_humidity.3": {"title": {"en": "Humidity Sensor 3", "nl": "Vochtsensor 3"}}},
      'energy': {},
      'triggers': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerTemperature1', 'triggerTemperature2', 'triggerTemperature3', 'triggerHumidity1', 'triggerHumidity2', 'triggerHumidity3', 'triggerPlusInputExternal1On', 'triggerPlusInputExternal1Off', 'triggerPlusInputExternal1Changed', 'triggerPlusInputExternal2On', 'triggerPlusInputExternal2Off', 'triggerPlusInputExternal2Changed', 'triggerPlusInputExternal3On', 'triggerPlusInputExternal3Off', 'triggerPlusInputExternal3Changed'],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_1", "rssi", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {"measure_temperature": {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}},"measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},"measure_temperature.2": {"title": {"en": "Temperature Sensor 2","nl": "Temperatuursensor 2"}},"measure_temperature.3": {"title": {"en": "Temperature Sensor 3", "nl": "Temperatuursensor 3"}},"measure_humidity.1": {"title": {"en": "Humidity Sensor 1", "nl": "Vochtsensor 1"}},"measure_humidity.2": {"title": {"en": "Humidity Sensor 2","nl": "Vochtsensor 2"}},"measure_humidity.3": {"title": {"en": "Humidity Sensor 3", "nl": "Vochtsensor 3"}}},
      'energy': {},
      'triggers': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerTemperature1', 'triggerTemperature2', 'triggerTemperature3', 'triggerHumidity1', 'triggerHumidity2', 'triggerHumidity3', 'triggerPlusInputExternal1On', 'triggerPlusInputExternal1Off', 'triggerPlusInputExternal1Changed', 'triggerPlusInputExternal2On', 'triggerPlusInputExternal2Off', 'triggerPlusInputExternal2Changed', 'triggerPlusInputExternal3On', 'triggerPlusInputExternal3Off', 'triggerPlusInputExternal3Changed'],
    ...
    },
    {
      ...
      'capabilities_1': ["windowcoverings_state", "windowcoverings_set", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_1", "input_2", "rssi", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {'measure_temperature': {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}}},
      'energy': {},
    ...
    },
    {
      ...
      'battery': false,
      'class': 'windowcoverings',
      'capabilities_1': ["windowcoverings_state", "windowcoverings_set", "measure_temperature", "input_1", "input_2", "rssi", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {'measure_temperature': {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}}},
      'energy': {},
      'triggers': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerInput2On', 'triggerInput2Off', 'triggerInput2Changed'],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_power", "meter_power", "measure_temperature", "input_1", "input_2", "rssi", "deviceGen1"],
      'capabilities_2': [],
      'capability_options': {"measure_temperature": {"title": {"en": "Device Temperature", "nl": "Apparaat temperatuur"}},"measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},"measure_temperature.2": {"title": {"en": "Temperature Sensor 2","nl": "Temperatuursensor 2"}},"measure_temperature.3": {"title": {"en": "Temperature Sensor 3", "nl": "Temperatuursensor 3"}}},
      'energy': {},
    ...
    },
    {
      ...
      'battery': false,
      'class': 'windowcoverings',
      'capabilities_1': ["windowcoverings_state", "windowcoverings_set", "measure_power", "meter_power", "input_1", "input_2", "rssi", "deviceGen1"],
      'capabilities_2': [],
      'capability_options': {},
      'energy': {},
      'triggers': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerInput2On', 'triggerInput2Off', 'triggerInput2Changed'],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_power", "meter_power_factor", "measure_current", "measure_voltage", "meter_power_returned", "meter_power", "meter_power.total", "rssi", "deviceGen1"],
      ...
      'triggers': ['triggerMeterPowerReturned', 'triggerMeterPowerFactor', 'triggerMeterPowerTotal'],
      'callbacks': [],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_power", "meter_power", "measure_voltage", "measure_current", "input_1", "measure_temperature", "rssi", "deviceGen2"],
      'capabilities_2': ["onoff", "measure_power", "meter_power", "measure_voltage", "measure_current", "input_1"],
      'capability_options': {'measure_temperature': {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}}},
      'energy': {},
      'triggers': [],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'windowcoverings',
      'capabilities_1': ["windowcoverings_state", "windowcoverings_set", "measure_power", "meter_power", "measure_temperature", "input_1", "input_2", "rssi", "deviceGen1"],
      'capabilities_2': [],
      'capability_options': {'measure_temperature': {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}}},
      'energy': {},
      'triggers': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerInput2On', 'triggerInput2Off', 'triggerInput2Changed'],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'light',
      'capabilities_1': ["onoff", "dim", "measure_power", "meter_power", "measure_temperature", "input_1", "input_2", "rssi", "deviceGen1"],
      'capabilities_2': [],
      'capability_options': {"dim": {"opts": {"duration": true }}},
      'energy': {},
      'triggers': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerInput2On', 'triggerInput2Off', 'triggerInput2Changed'],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'other',
      'capabilities_1': ["input_1", "input_2", "input_3", "rssi", "deviceGen1"],
      'capabilities_2': [],
      'capability_options': {},
      'energy': {},
    ...
    },
    {
      ...
      'battery': false,
      'class': 'other',
      'capabilities_1': ["input_1", "input_2", "input_3", "input_4", "rssi", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {"measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},"measure_temperature.2": {"title": {"en": "Temperature Sensor 2","nl": "Temperatuursensor 2"}},"measure_temperature.3": {"title": {"en": "Temperature Sensor 3", "nl": "Temperatuursensor 3"}},"measure_humidity.1": {"title": {"en": "Humidity Sensor 1", "nl": "Vochtsensor 1"}},"measure_humidity.2": {"title": {"en": "Humidity Sensor 2","nl": "Vochtsensor 2"}},"measure_humidity.3": {"title": {"en": "Humidity Sensor 3", "nl": "Vochtsensor 3"}}},
      'energy': {},
      'triggers': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerInput2On', 'triggerInput2Off', 'triggerInput2Changed', 'triggerInput3On', 'triggerInput3Off', 'triggerInput3Changed', 'triggerInput4On', 'triggerInput4Off', 'triggerInput4Changed', 'triggerTemperature1', 'triggerTemperature2', 'triggerTemperature3', 'triggerHumidity1', 'triggerHumidity2', 'triggerHumidity3', 'triggerPlusInputExternal1On', 'triggerPlusInputExternal1Off', 'triggerPlusInputExternal1Changed', 'triggerPlusInputExternal2On', 'triggerPlusInputExternal2Off', 'triggerPlusInputExternal2Changed', 'triggerPlusInputExternal3On', 'triggerPlusInputExternal3Off', 'triggerPlusInputExternal3Changed'],
      'callbacks': ['single_push_1', 'long_push_1', 'double_push_1', 'triple_push_1', 'single_push_2', 'long_push_2', 'double_push_2', 'triple_push_2', 'single_push_3', 'long_push_3', 'triple_push_3', 'double_push_3', 'single_push_4', 'long_push_4', 'double_push_4', 'triple_push_4'],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'light',
      'capabilities_1': ["onoff", "dim", "light_temperature", "light_hue", "light_saturation", "measure_power", "meter_power", "light_mode", "onoff.whitemode", "input_1", "rssi", "deviceGen1"],
      'capabilities_2': [],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'light',
      'capabilities_1': ["onoff", "dim", "rssi", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {"dim": {"opts": {"duration": false }}},
      'energy': {},
      'triggers': [],
      'callbacks': [],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["measure_power", "measure_power.total", "measure_current", "measure_current.total", "measure_voltage", "meter_power_factor", "meter_power", "meter_power.returned", "meter_power.total", "meter_power.total_returned", "measure_temperature", "rssi", "deviceGen2"],
      'capabilities_2': ["measure_power", "measure_current", "measure_voltage", "meter_power_factor", "meter_power", "meter_power.returned" ],
      'capability_options': {
        ...
        "measure_power.total_returned": {"title": {"en": "Total Energy Returned", "nl": "Totale retour energie"}}
      },
      'energy': {"cumulative": true},
    ...
    {
      'hostname': ['shellyplusplugs-', 'ShellyPlusPlugS-', 'shellyplusplugit-', 'ShellyPlusPlugIT-', 'shellypluspluguk-', 'ShellyPlusPlugUK-', 'shellyplusplugus-', 'ShellyPlusPlugUS-'],
      ...
      'battery': false,
      'class': 'socket',
      'capabilities_1': ["onoff", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "rssi", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {'measure_temperature': {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}}},
      'energy': {},
      'triggers': [],
  ...
  async sendCommand(endpoint, address, username, password) {
    try {
      ...
      const response = await fetch('http://'+ address + endpoint, options);
  ...
  async sendRPCCommand(endpoint, address, password, requesttype='GET', payload={}) {
    try {
      ...
      if (response.status === 401) {
        ...
        if (response.headers.get("www-authenticate") != undefined && (this.digest_retries[address] <= 2 || this.digest_retries[address] == undefined)) {
          this.digest_retries[address]++;
          const challenges = Auth.parseHeaders(response.headers.get("www-authenticate"));
          ...
          const response_auth = await fetch('http://'+ address + endpoint, options);
          this.checkStatus(response_auth);
          this.digest_retries[address] = 0;
          const data_auth = await response_auth.json();
          return Promise.resolve(data_auth);
        }
      } else {
        this.checkStatus(response);
        const data = await response.json();
