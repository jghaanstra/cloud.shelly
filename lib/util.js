...
class Util {
  ...
  static deviceConfig = [
    ...
    },
    {
      ...
      'capabilities_2': [],
      'capability_options': {"measure_temperature": {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}},"measure_temperature.1": {"title": {"en": "Temperature Sensor 1", "nl": "Temperatuursensor 1"}},"measure_temperature.2": {"title": {"en": "Temperature Sensor 2","nl": "Temperatuursensor 2"}},"measure_temperature.3": {"title": {"en": "Temperature Sensor 3", "nl": "Temperatuursensor 3"}},"measure_humidity.1": {"title": {"en": "Humidity Sensor 1", "nl": "Vochtsensor 1"}},"measure_humidity.2": {"title": {"en": "Humidity Sensor 2","nl": "Vochtsensor 2"}},"measure_humidity.3": {"title": {"en": "Humidity Sensor 3", "nl": "Vochtsensor 3"}},"button.enable_ble_script": {"maintenanceAction": true, "title": {"en": "Start BLE Proxy", "nl": "Start BLE Proxy"}},"button.disable_ble_script": {"maintenanceAction": true, "title": {"en": "Stop BLE Proxy", "nl": "Stop BLE Proxy"}}},
      'energy': {},
    ...
    },
    {
      ...
      'capabilities_1': ["windowcoverings_state", "windowcoverings_set", "measure_power", "meter_power", "measure_voltage", "measure_current", "measure_temperature", "input_1", "input_2", "rssi", "button.enable_ble_script", "button.disable_ble_script", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {'measure_temperature': {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}},"button.enable_ble_script": {"maintenanceAction": true, "title": {"en": "Start BLE Proxy", "nl": "Start BLE Proxy"}},"button.disable_ble_script": {"maintenanceAction": true, "title": {"en": "Stop BLE Proxy", "nl": "Stop BLE Proxy"}}},
      'energy': {},
    ...
    },
    {
      ...
      'battery': false,
      'class': 'windowcoverings',
      'capabilities_1': ["windowcoverings_state", "windowcoverings_set", "measure_temperature", "input_1", "input_2", "rssi", "button.enable_ble_script", "button.disable_ble_script", "deviceGen2"],
      'capabilities_2': [],
      'capability_options': {'measure_temperature': {"title": {"en": "Device Temperature","nl": "Apparaat temperatuur"}},"button.enable_ble_script": {"maintenanceAction": true, "title": {"en": "Start BLE Proxy", "nl": "Start BLE Proxy"}},"button.disable_ble_script": {"maintenanceAction": true, "title": {"en": "Stop BLE Proxy", "nl": "Stop BLE Proxy"}}},
      'energy': {},
      'triggers': ['triggerInput1On', 'triggerInput1Off', 'triggerInput1Changed', 'triggerInput2On', 'triggerInput2Off', 'triggerInput2Changed'],
    ...
    },
    {
      ...
      'battery': false,
      'class': 'other',
      'capabilities_1': ["input_1", "input_2", "input_3", "input_4", "rssi", "button.enable_ble_script", "button.disable_ble_script", "deviceGen2"],
      'capabilities_2': [],
    ...
    },
    {
      ...
      'battery': true,
      'class': 'sensor',
      'capabilities_1': ["measure_battery", "alarm_contact", "measure_lux", "tilt", "rssi", "deviceBLU"],
      'capabilities_2': [],
      'capability_options': {},
 ...
 // SUPPORTED DEVICES
 let supported_device = ['SBBT-002C', 'SBDW'];
 ...
 BTH[0x05] = { n: 'measure_lux', t: uint24, f: 0.01 };
