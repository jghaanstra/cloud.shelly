...
class Shelly2Device extends Homey.Device {
  ...
  onInit() {
    ...
    this.registerCapabilityListener('button.triggers', async () => {
      ...
      var btn_on_url = '/settings/relay/0?btn_on_url=http://'+ homeyip +'/api/app/cloud.shelly/button_actions/shelly2/'+ this.getData().id +'/btn_on/';
      var btn_off_url = '/settings/relay/0?btn_off_url=http://'+ homeyip +'/api/app/cloud.shelly/button_actions/shelly2/'+ this.getData().id +'/btn_off/';
      var out_on_url = '/settings/relay/0?out_on_url=http://'+ homeyip +'/api/app/cloud.shelly/button_actions/shelly2/'+ this.getData().id +'/out_on/';
      var out_off_url = '/settings/relay/0?out_off_url=http://'+ homeyip +'/api/app/cloud.shelly/button_actions/shelly2/'+ this.getData().id +'/out_off/';
      var shortpush_url = '/settings/relay/0?shortpush_url=http://'+ homeyip +'/api/app/cloud.shelly/button_actions/shelly2/'+ this.getData().id +'/shortpush/';
      var longpush_url = '/settings/relay/0?longpush_url=http://'+ homeyip +'/api/app/cloud.shelly/button_actions/shelly2/'+ this.getData().id +'/longpush/';
