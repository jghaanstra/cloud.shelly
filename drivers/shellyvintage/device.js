...
class ShellyVintageDevice extends Homey.Device {
  ...
  onInit() {
    ...
    this.registerCapabilityListener('button.triggers', async () => {
      ...
      var out_on_url = '/settings/relay/0?out_on_url=http://'+ homeyip +'/api/app/cloud.shelly/button_actions/shellyduo/'+ this.getData().id +'/out_on/';
      var out_off_url = '/settings/relay/0?out_off_url=http://'+ homeyip +'/api/app/cloud.shelly/button_actions/shellyduo/'+ this.getData().id +'/out_off/';
